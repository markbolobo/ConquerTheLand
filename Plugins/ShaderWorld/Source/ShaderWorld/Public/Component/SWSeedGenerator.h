...
#include "SWSeedGenerator.generated.h"

#if WITH_EDITOR
DECLARE_MULTICAST_DELEGATE_OneParam(FOnSWSeedGeneratorChanged, USWSeedGenerator*);
 ...
 * 
 */
UCLASS(Abstract, BlueprintType, Blueprintable, EditInlineNew, CollapseCategories, hidecategories = (Object))
class SHADERWORLD_API USWSeedGenerator : public UObject
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintNativeEvent, Category = Execution)
		void GenerateSeed( FSWBagOfSeeds& Output);
	...
	FOnSWSeedGeneratorChanged OnBlueprintChangedDelegate;
#endif
