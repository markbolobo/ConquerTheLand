...
class SHADERWORLD_API SWHISMComponentSceneProxy final : public FInstancedStaticMeshSceneProxy
{
...
public:
	...
	SWHISMComponentSceneProxy(USWHISMComponent* InComponent, ERHIFeatureLevel::Type InFeatureLevel);
