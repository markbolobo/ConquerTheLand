...
#include "SWFoliageInstancedSMeshComponent.generated.h"

/**
 * 
 */
UCLASS(ClassGroup = Foliage, Blueprintable)
class SHADERWORLD_API USWCollectableInstancedSMeshComponent : public USWHISMComponent
{
	GENERATED_UCLASS_BODY()
	
	public:

		bool RemoveInstance(int32 InstanceIndex) override;

		UPROPERTY(Transient)
			UHierarchicalInstancedStaticMeshComponent* Visual_Mesh_Owner = nullptr;
		...
		TSharedPtr < FSWRedirectionIndexes, ESPMode::ThreadSafe> Redirection;

		FThreadSafeBool RedirectionUpdating;
		TArray<int32> RemovalDuringRedirectionUpdate;
