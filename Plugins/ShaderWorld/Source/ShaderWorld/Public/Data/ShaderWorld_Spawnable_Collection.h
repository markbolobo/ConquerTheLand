 ...
 */
UCLASS()
class SHADERWORLD_API UShaderWorld_Biom : public UObject
{
	GENERATED_BODY()
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "")
		FLinearColor VisualizationColor = FLinearColor::Yellow;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "")
		UMaterialInterface* BiomDensitySpawner = nullptr;
