...
void USWSeedGenerator::PostLoad()
{
	UObject::PostLoad();
}

void USWSeedGenerator::BeginDestroy()
{
	UObject::BeginDestroy();
}

void USWSeedGenerator::GenerateSeed_Implementation(FSWBagOfSeeds& Output)
{
	//Execute(Output);
}

#if WITH_EDITOR
void USWSeedGenerator::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
